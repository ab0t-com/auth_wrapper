...
| [references/FAQ.md](references/FAQ.md) | Frequently asked questions organized by customer journey stage — getting started, setup, permissions, multi-tenancy, debugging | Quick answers to common questions, onboarding new developers |
